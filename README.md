...
This repository contains the RStudio code used in my Master's thesis. The thesis investigates the spatial relationship between socio-economic heat sensitivity and heat exposure in Berlin using open-source spatial data.
