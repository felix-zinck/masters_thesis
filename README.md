...
This repository contains the RStudio code used in my Master's thesis. The thesis is a spatial overlay analysis that investigates the relationship between socio-economic heat sensitivity and heat exposure in Berlin using open-source data.
