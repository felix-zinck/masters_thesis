...
write_csv(share_ind_out_of_bounds,
  file.path(appendix_path, "02_appendix_table_share_indicators_out_of_bounds.csv"))
...
png(
  filename = file.path(appendix_path, "appendix_03_figure_indicator_correlation_matrix.png"),
  width = 120,
  height = 100,
  units = "mm",
  res = 300
